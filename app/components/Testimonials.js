...
export default function Testimonials() {
  const testimonials = [
    {
      ...
      text: 'Vaibhav is an exceptional frontend developer with deep expertise in React and Next.js. He delivered 9+ production applications with outstanding quality and performance.',
    ...
    },
    {
      ...
      text: 'Working with Vaibhav on our healthcare platform was excellent. He implemented HIPAA-compliant features and delivered a robust EHR system that exceeded our expectations.',
    ...
    },
    {
      ...
      text: 'Vaibhav built our e-commerce platform with exceptional attention to user experience. The site is fast, responsive, and beautiful. Sales increased by 35% after launch.',
    ...
    },
    {
      ...
      text: 'Outstanding work on our financial management platform. Vaibhav delivered a complex application with clean code, excellent performance, and intuitive UI. A true professional!',
  ...
  const Card = ({ t }) => (
    ...
    >
      ...
      <div className="relative">
        ...
        <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed pl-5">{t.text}</p>
      </div>
  ...
  return (
    <section id="testimonials" className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-emerald-50 via-white to-emerald-50 dark:from-emerald-950/20 dark:via-dark-200 dark:to-emerald-950/20 relative overflow-hidden">
